...
[x] Ir até a API/Servidor. e trazer as receitas
...
async function searchRecipes(ingredient) {
    recipeList.innerHTML = `<p>Carregandos Receitas...</p>`
    try {
...
async function getRecipesDetails(id) {
    ...
    <p>${recipe.strTags}</p>
    <p>Video:<a href="${recipe.strYoutube}" target="_blank">Assista no Youtube</p>
